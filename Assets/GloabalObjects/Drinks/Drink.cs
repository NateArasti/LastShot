...
public class Drink : ScriptableObject, IDatabaseObject, ISpriteDatabaseObject
{
    ...
    public struct Receipt
    {
        ...
        [SerializeField] private List<Ingredient> _alcohols;
        [SerializeField] private List<Ingredient> _additionalIngredients;
        ...
        public IReadOnlyCollection<Ingredient> Alcohols => _alcohols;
        public IReadOnlyCollection<Ingredient> Ingredients => _additionalIngredients;
    }
